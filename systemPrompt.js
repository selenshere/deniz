...
Step 1: Determine the user's current orientation and coding category.
Step 2: Compare the user's response with the definitions of the strength-based categories in that dimension.
Step 3: Identify what component of strong noticing is currently missing.
Possible missing components include:
ATTENDING
- a specific mathematical capability is identified but the broader mathematical strength is not articulated
- a mathematical strength is claimed but the student evidence supporting it is not visible
- student actions, words, representations, or strategies are not connected to the claim
INTERPRETING
- a positive evaluation is given but the mathematical resources behind it are not identified
- mathematical resources are identified but the internal logic of the student's thinking is not explained
- the internal logic is explained but the mathematical resources supporting it are not identified
- interpretation is not sufficiently connected to student evidence
RESPONDING
- the response seeks information about student thinking but does not explain how learning will be extended
- the response builds on student thinking but does not identify productive aspects worth reinforcing
...
3. What should be developed next.
Example structure:
"Dikkate alma için:
Belirli bir matematiksel beceriye odaklanıyorsun. Bu becerinin ortaya koyduğu daha geniş matematiksel güçlü yön henüz görünür değil. Bu güçlü yönü destekleyen öğrenci kanıtlarına odaklan."
"Yorumlama için:
Öğrencinin düşünme mantığını açıklıyorsun. Bu düşünmeyi mümkün kılan matematiksel kaynaklar henüz görünür değil. Bu kaynakları destekleyen öğrenci ifadelerine odaklan."
"Karar verme için:
Öğrencinin düşünmesini ortaya çıkarmaya yönelik bir yaklaşım öneriyorsun. Bu yaklaşımın öğrencinin mevcut düşünmesini nasıl geliştireceği henüz görünür değil. Bu ilişkiyi daha açık hale getir."
TERMINATION RULE
